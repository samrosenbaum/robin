...
const TREE: TreeNode[] = [
  ...
  { type: "file", name: "eve.ts", depth: 2 },
  { type: "folder", name: "tools/", depth: 1, id: "tools" },
  { type: "file", name: "research_company.ts", depth: 2, badge: "new" },
  { type: "file", name: "tailor_pitch.ts", depth: 2, badge: "new" },
  { type: "file", name: "generate_landing_page.ts", depth: 2, badge: "new" },
  { type: "file", name: "verify_in_sandbox.ts", depth: 2, badge: "new" },
  { type: "file", name: "fix_with_v0.ts", depth: 2 },
  { type: "folder", name: "skills/", depth: 1, id: "skills" },
  { type: "file", name: "stack-detection.md", depth: 2, badge: "new" },
  { type: "file", name: "vercel-positioning.md", depth: 2, badge: "new" },
  { type: "file", name: "v0-prompting.md", depth: 2 },
  { type: "file", name: "copy-craft.md", depth: 2 },
  { type: "file", name: "live-meeting-voice.md", depth: 2, badge: "new" },
